...
<div class="product-card" data-product-id="{{ $product->id }}">
    ...
    <div class="product-image">
        <a href="{{ route('product.show', $product->id) }}">
            <img src="{{ $product->image ?? asset('images/domproduct-placeholder.png') }}" 
                 alt="{{ app()->getLocale() == 'uz' ? $product->name_uz : $product->name }}"
                 loading="lazy"
                 onerror="this.src='{{ asset('images/domproduct-placeholder.png') }}'">
        </a>
    ...
    <div class="product-actions">
        ...
        <div class="secondary-actions">
            ...
            <a href="{{ route('product.show', $product->id) }}" class="btn btn-outline view-btn" title="{{ __('Batafsil') }}">
                <i class="fas fa-eye"></i>
            </a>
        </div>
    </div>
