        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a href="{{ route('template.mobile.products') }}" class="btn btn-primary">
                        <i class="fas fa-shopping-bag"></i>
                        {{ __('Xarid qilish') }}
                    </a>
                    <a href="{{ route('template.mobile.categories') }}" class="btn btn-outline">
    ...
    <section class="categories-section">
        <div class="container">
            <div class="section-header">
                ...
                <a href="{{ route('template.mobile.categories') }}" class="view-all-link">
            ...
            <div class="categories-grid">
                ...
                <a href="{{ route('template.mobile.products', ['category' => $category->slug]) }}" class="category-card">
    ...
    <section class="featured-products">
        <div class="container">
            <div class="section-header">
                ...
                <a href="{{ route('template.mobile.products') }}" class="view-all-link">
                    {{ __('Barchasini ko\'rish') }}
                    <i class="fas fa-arrow-right"></i>
                </a>
            </div>
    ...
    <section class="new-products">
        <div class="container">
            <div class="section-header">
                ...
                <a href="{{ route('template.mobile.products', ['sort' => 'newest']) }}" class="view-all-link">
                    {{ __('Barchasini ko\'rish') }}
                    <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="products-grid">
                @foreach($newProducts as $product)
                    @include('template.mobile.components.product-card', ['product' => $product])
                @endforeach
            </div>
        </div>
    </section>
